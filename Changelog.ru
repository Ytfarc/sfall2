...
01/07/15
* Переменную DebugMode теперь можно использовать не только в отладочном, но и в релизном варианте dll.
! Исправлен "Unlimited Ammo bug".

28/06/15
! Исправлен баг при котором 9 строку в диалоговом варианте ответа нельзя использовать.
...
+ Для кнопки "Взять всё" помимо "горячей" клавиши 'A' можно использовать и клавишу 'a'.
...
19/02/15
+ Добавлена переменная ArmorFile для реализации движкового "NPC armor" мода. Отличие от скриптового варианта заключается в дополнительной возможности изменения внешнего вида сопартийца ещё и на картинке в окне настроек сопартийца.
