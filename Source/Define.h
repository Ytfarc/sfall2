...
#define PERK_phoenix_enhancement        (77)
...
#define PERK_autodoc_hp_neg1            (114)
#define PERK_autodoc_hp_neg2            (115)
#define PERK_expert_excrement_expediter (116)
